class Estacionamento(object):
    ...
    def comparar_horario_de_carros(self, carro2):
        if self.horario_de_entrada > carro2.horario_de_entrada:
            return (f'O carro {self.get_modelo_do_carro()} chegou depois que o {carro2.get_modelo_do_carro()}')
        else:
            return (f'O carro {self.get_modelo_do_carro()} chegou antes que o primeiro {carro2.get_modelo_do_carro()}')

    @classmethod
    def compara_maior_horario(cls, objeto1, objeto2):
        return objeto1.get_horario_de_entrada() == objeto2.get_horario_de_entrada()
...
if __name__ == '__main__':
    ...
    carro1.set_horario_de_entrada(13.47)
    ...
    print(carro1.comparar_horario_de_carros(carro2))

    print(f"O {carro1.get_modelo_do_carro()} chegou na mesma hora do {carro2.get_modelo_do_carro()}:", Estacionamento.compara_maior_horario(carro1, carro2))