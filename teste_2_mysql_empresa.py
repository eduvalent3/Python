...
def menu():
    while True:
        ...
        print("[4] Para mostrar todos os Registros de Empregado com Join (nome do cargo e não código)")
        print("[5] Para Deletar um Empregado")
        print("[0] Para Sair")
